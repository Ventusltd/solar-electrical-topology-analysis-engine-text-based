"""Disposable B026-03 bundle hook; never merge into production."""
...
def _write_bundle() -> None:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="b026-03-bundle-") as raw:
            workspace = Path(raw)
            ...
            bundle = workspace / "b026-03-local-bundle.zip"
